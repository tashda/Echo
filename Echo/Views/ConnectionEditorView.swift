...
struct ConnectionEditorView: View {
    ...
    private func handleSave(action: SaveAction) {
        ...
        let sanitizedCredentialSource: CredentialSource = selectedDatabaseType == .sqlite ? .manual : credentialSource
    ...
    private func browseForSQLiteFile() {
        ...
        panel.allowedFileTypes = ["sqlite", "sqlite3", "db", "db3"]
    ...
    private func startConnectionTest() {
        ...
        let connection = SavedConnection(
            ...
            username: selectedDatabaseType == .sqlite ? "" : username,
            credentialSource: selectedDatabaseType == .sqlite ? .manual : credentialSource,
        ...
        if selectedDatabaseType == .sqlite {
            ...
            overridePassword = credentialSource == .manual ? password : nil
        }
        testTask = Task {
