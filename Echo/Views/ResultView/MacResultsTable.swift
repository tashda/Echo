    ...
    final class Coordinator: NSObject, NSTableViewDelegate, NSTableViewDataSource, NSMenuDelegate {
        ...
        func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
            ...
            if isSelectedCell {
                ...
                textField.backgroundColor = NSColor.controlAccentColor.withAlphaComponent(0.25)
                textField.textColor = .labelColor
            } else if isHighlightedColumn {
                textField.drawsBackground = true
                textField.backgroundColor = NSColor.controlAccentColor.withAlphaComponent(0.12)
            } else {
        ...
        func tableView(_ tableView: NSTableView, shouldSelectRow row: Int) -> Bool {
            ...
            guard clickedColumn >= 0 else { return true }
        ...
        func tableViewSelectionDidChange(_ notification: Notification) {
            ...
            if let region = selectionRegion, hasRowSelection {
