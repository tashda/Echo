...
struct FinderStyleFolderView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 1) {
            ...
            .contextMenu {
                Button {
                    onEditItem(.folder(folder))
                } label: {
                    Label("Edit Folder...", systemImage: "square.and.pencil")
                }
                Button {
                    onDuplicateItem(.folder(folder))
                } label: {
                    Label("Duplicate Folder", systemImage: "plus.square.on.square")
                }
                Divider()
                Button {
