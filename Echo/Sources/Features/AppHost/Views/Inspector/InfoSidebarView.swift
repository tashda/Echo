...
struct InfoSidebarView: View {
    ...
    @EnvironmentObject private var environmentState: EnvironmentState // Temporary bridge for content and actions
    ...
    private var connectionInspectorContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            if let session = environmentState.sessionManager.activeSession {
