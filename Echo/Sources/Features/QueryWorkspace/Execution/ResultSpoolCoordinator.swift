...
actor ResultSpoolCoordinator {
    ...
    func clearAll() async {
        ...
        do {
            ...
            print("ResultSpoolCoordinator: Failed to clear cache \(error)")
        }
    }
    ...
    private static func ensureDirectoryExists(_ url: URL) {
        do {
            ...
            print("ResultSpoolCoordinator: Failed to create cache directory \(error)")
        }
    }
