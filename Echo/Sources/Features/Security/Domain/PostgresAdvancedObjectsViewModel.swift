...
final class PostgresAdvancedObjectsViewModel {
    ...
    func initialize() async {
        ...
        if availableSchemas.isEmpty {
            do { availableSchemas = try await pg.client.introspection.listSchemas().map(\.name) }
    ...
    private func loadForeignData(pg: PostgresSession) async {
        ...
        do {
            fdws = try await pg.client.introspection.listForeignDataWrappers()
            foreignServers = try await pg.client.introspection.listForeignServers()
        } catch {
    ...
    private func loadEventTriggers(pg: PostgresSession) async {
        ...
        do { eventTriggers = try await pg.client.introspection.listEventTriggers() }
    ...
    private func loadDomains(pg: PostgresSession) async {
        ...
        do { domains = try await pg.client.introspection.listDomains(schema: schemaFilter) }
    ...
    private func loadCompositeTypes(pg: PostgresSession) async {
        ...
        do { compositeTypes = try await pg.client.introspection.listCompositeTypes(schema: schemaFilter) }
    ...
    private func loadRangeTypes(pg: PostgresSession) async {
        ...
        do { rangeTypes = try await pg.client.introspection.listRangeTypes(schema: schemaFilter) }
    ...
    private func loadCollations(pg: PostgresSession) async {
        ...
        do { collations = try await pg.client.introspection.listCollations(schema: schemaFilter) }
    ...
    private func loadFTSConfigs(pg: PostgresSession) async {
        ...
        do { ftsConfigs = try await pg.client.introspection.listTextSearchConfigurations(schema: schemaFilter) }
    ...
    private func loadRules(pg: PostgresSession) async {
        ...
        do { rules = try await pg.client.introspection.listRules(schema: schemaFilter) }
    ...
    private func loadTablespaces(pg: PostgresSession) async {
        ...
        do { tablespaces = try await pg.client.introspection.listTablespaces() }
    ...
    private func loadAggregates(pg: PostgresSession) async {
        ...
        do { aggregates = try await pg.client.introspection.listAggregates(schema: schemaFilter) }
    ...
    private func loadOperators(pg: PostgresSession) async {
        ...
        do { operators = try await pg.client.introspection.listOperators(schema: schemaFilter) }
    ...
    private func loadLanguages(pg: PostgresSession) async {
        ...
        do { languages = try await pg.client.introspection.listLanguages() }
    ...
    private func loadCasts(pg: PostgresSession) async {
        ...
        do { casts = try await pg.client.introspection.listCasts() }
