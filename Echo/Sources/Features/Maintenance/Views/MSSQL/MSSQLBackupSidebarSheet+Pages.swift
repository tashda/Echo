        ...
        Group {
            ...
            Section("Destination") {
                PropertyRow(
                    ...
                    info: "A file path on the SQL Server machine. The SQL Server service account must have write access to this location."
                ) {
                    TextField("", text: $viewModel.diskPath, prompt: Text("/var/backups/mydb.bak"))
