...
struct PublicationEditorView: View {
    ...
    @State private var selectedPage: PublicationEditorPage? = .general

    private var displayName: String {
        viewModel.publicationName.isEmpty ? "New Publication" : viewModel.publicationName
    }
    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                if selectedPage == .sql {
                    PublicationEditorSQLPage(viewModel: viewModel)
                } else {
                    formDetail
                }
            }
    ...
    private var pageContent: some View {
        switch selectedPage {
        case .general:
            PublicationEditorGeneralPage(viewModel: viewModel)
        case .tables:
            PublicationEditorTablesPage(viewModel: viewModel)
        case .sql, nil:
            EmptyView()
        }
    }
