...
struct SubscriptionEditorView: View {
    ...
    @State private var selectedPage: SubscriptionEditorPage? = .general

    private var displayName: String {
        viewModel.subscriptionName.isEmpty ? "New Subscription" : viewModel.subscriptionName
    }
    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                if selectedPage == .sql {
                    SubscriptionEditorSQLPage(viewModel: viewModel)
                } else {
                    formDetail
                }
            }
    ...
    private var pageContent: some View {
        switch selectedPage {
        case .general:
            SubscriptionEditorGeneralPage(viewModel: viewModel)
        case .options:
            SubscriptionEditorOptionsPage(viewModel: viewModel)
        case .sql, nil:
            EmptyView()
        }
    }
