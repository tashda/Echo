...
struct TriggerEditorView: View {
    ...
    @State private var selectedPage: TriggerEditorPage? = .general

    private var displayName: String {
        viewModel.triggerName.isEmpty ? "New Trigger" : viewModel.triggerName
    }
    ...
    private var sqlDetail: some View {
        TriggerEditorSQLPage(viewModel: viewModel)
    }
    ...
    private var pageContent: some View {
        switch selectedPage {
        case .general:
            TriggerEditorGeneralPage(viewModel: viewModel)
        case .events:
            TriggerEditorEventsPage(viewModel: viewModel)
        case .sql, nil:
            EmptyView()
        }
    }
