...
final class ClipboardHistoryStore: ObservableObject {
    struct UsageBreakdown: Equatable {
        ...
        static let empty = UsageBreakdown(queryBytes: 0, gridBytes: 0)
    }
    ...
    struct Entry: Identifiable, Equatable, Codable {
        ...
        struct Metadata: Equatable, Codable {
            ...
            func updating(serverName: String? = nil, databaseName: String? = nil, objectName: String? = nil) -> Metadata {
                Metadata(
            ...
            static var empty: Metadata { Metadata(serverName: nil, databaseName: nil, objectName: nil) }
        }
