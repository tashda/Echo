...
- current UI covers users, role inventory/assignments, password changes, grants, account limits inspection/editing, administrative role inspection/editing, schema-level grant/revoke flows, plus create/lock/unlock/drop flows
- full Workbench-style multi-tab user editor and schema privilege matrix remain outstanding
