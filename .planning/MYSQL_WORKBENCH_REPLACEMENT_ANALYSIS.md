...
- current UI covers users, role inventory/assignments, grants, account limits, administrative role inspection, schema-level grant/revoke flows, plus create/lock/unlock/drop flows
